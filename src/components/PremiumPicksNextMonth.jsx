      ...
      <div>
        <div className="bg-[#F6F2FF] w-full h-45 flex flex-col items-center">
          <p className="text-gray-800 font-semibold text-center mt-5 mb-5">
            ...
            any Premium or Premium+ plan. (this in next month)
          </p>
          <div className="bg-[#291C61] flex items-center gap-1 rounded-full px-5 py-2.5 w-45 my-5 cursor-pointer">
            <AiFillThunderbolt color="white" />
            <button className="font-bold text-white cursor-pointer">Subscribe now</button>
          </div>
        </div>
        ...
        <div>
          <div className="flex flex-col mt-6 mx-5 mb-5">
            <div className="mt-2 flex gap-5 mb-3">
              ...
              />
              <div>
                <h1 className="text-xl font-bold">Playing By The Rules</h1>
                <p className="font-semibold my-3">BrandonWong048</p>
                <div className="flex items-center gap-4 mt-5 mb-2">
                  <div className="flex items-center gap-2 mt-2">
                    <IoEyeSharp size={16} color="gray" />
                    <p className="text-sm font-semibold text-gray-400">18.8M</p>
                  </div>
                  <div className="flex items-center gap-2 mt-2">
                    <IoIosStar size={15} color="gray" />
                    <p className="text-sm font-semibold text-gray-400">52.7k</p>
                  </div>
                  <div className="flex items-center gap-2 mt-2">
                    <FaList size={14} color="gray" />
                    <p className="text-sm font-semibold text-gray-400">29</p>
                  </div>
                </div>
                <div className="flex gap-2 items-center">
                  <p className="text-sm font-bold mt-2 bg-[#E2E2E2] text-gray-900 rounded-full py-1 px-3 w-18">
                    badboy
                  </p>
                  <p className="text-sm font-bold mt-2 bg-[#E2E2E2] text-gray-900 rounded-full py-1 px-3 w-18">
                    broken
                  </p>
                  <p className="text-sm font-bold mt-2 text-gray-700">+23 more</p>
                </div>
              </div>
            </div>
            <p className="mt-1 text-gray-700 mb-4">
            ...
            <div className="flex gap-5 my-5">
              <div className="flex items-center gap-2 bg-neutral-900 rounded-full px-4 py-2">
                <ButtonStartReading />
                <button className="font-bold text-white">Start reading</button>
              </div>
        ...
        <div>
          <div className="flex flex-col mt-6 mx-5 mb-5">
            <div className="mt-2 flex gap-5 mb-3">
              ...
              />
              <div>
                <h1 className="text-xl font-bold">Blood of Covenant</h1>
                <p className="font-semibold my-3">Author2</p>
                <div className="flex items-center gap-4 mt-5 mb-2">
                  <div className="flex items-center gap-2 mt-2">
                    <IoEyeSharp size={16} color="gray" />
                    <p className="text-sm font-semibold text-gray-400">18.8M</p>
                ...
                <div className="flex gap-2 items-center">
                  <p className="text-sm font-bold mt-2 bg-[#A01C43] text-white rounded-full py-1 px-3 w-18">
                    Mature
                  </p>
                  <p className="text-sm font-bold mt-2 bg-[#E2E2E2] text-gray-700 rounded-full py-1 px-3 w-18">
                    broken
                  </p>
                  <p className="text-sm font-bold mt-2 text-gray-700">+23 more</p>
                </div>
        ...
        <div>
          <div className="flex flex-col mt-6 mx-5 mb-5">
            <div className="mt-2 flex gap-5 mb-3">
              ...
              />
              <div>
                <h1 className="text-xl font-bold">Painted Wings (An Anastasia Remix)</h1>
                <p className="font-semibold my-3">Author3</p>
                <div className="flex items-center gap-4 mt-5 mb-2">
                  <div className="flex items-center gap-2 mt-2">
                    <IoEyeSharp size={16} color="gray" />
                    <p className="text-sm font-semibold text-gray-400">18.8M</p>
...
export default PremiumPicksNextMonth;
